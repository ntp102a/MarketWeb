...
namespace MarketWeb.Areas.Admin.Controllers
{
    ...
    public class AdminOrdersController : Controller
    {
        ...
        public IActionResult Index(int? page)
        {
            ...
            var pageSize = 20;
            var IsOrders = _context.Orders.Include(o => o.Customer).Include(o => o.TransactStatus)
                .AsNoTracking()
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var fullAddress = $"{order.Address}, {phuongxa}, {quanhuyen}, {tinhthanh}";
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            _notyfService.Success("Xoá đơn hàng thành công");
            return RedirectToAction(nameof(Index));
        }
